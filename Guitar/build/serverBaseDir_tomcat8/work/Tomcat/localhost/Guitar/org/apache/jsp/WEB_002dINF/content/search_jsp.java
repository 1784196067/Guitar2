 ...
 * Generated at: 2017-05-14 01:40:02 UTC
...
return;
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body class=\"row\"  onload=\"init()\">\r\n");
      ...
      out.write("    </div>\r\n");
      out.write("    <article class=\"row\"  style=\"height:auto;min-height:600px;\">\r\n");
      out.write("\t\t\t<ul id=\"ul\">\r\n");
      out.write("\t\t\t\t<li id=\"ul_item1\" class=\"li\">添加/修改乐器类别</li>\r\n");
      out.write("\t\t\t\t<li id=\"ul_item2\">添加商品乐器</li>\r\n");
      out.write("\t\t\t\t<li id=\"ul_item3\">商品乐器搜索</li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t<section id=\"sections\">\r\n");
      out.write("\t\t\t<section id=\"model1\">\r\n");
      out.write("\t\t\t\t<label style=\"margin-left:13px;margin-bottom:13px;\">乐器类别名：</label>\r\n");
      out.write("\t\t\t\t<select id=\"kind1\" style=\"width:90px;text-align: left;\" onchange=\"change(1)\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</select>&nbsp;&nbsp;<span class='glyphicon glyphicon-plus' onclick='addNew()'></span>\r\n");
      out.write("\t\t\t\t<form id=\"form1\">\r\n");
      out.write("\t\t\t\t  <div id=\"characters1\" class=\"input\">\t\t\t\t    \r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t\t<span class=\"btn btn-info\" style=\"float:right;\" onclick=\"save(1, 'save')\" id=\"save\"><span class=\"glyphicon glyphicon-ok\"></span>保存</span>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</section>\r\n");
      out.write("\t\t\t<section id=\"model2\">\r\n");
      out.write("\t\t\t\t<label style=\"margin-left:13px;margin-bottom:13px;\">乐器类别名：</label>\r\n");
      out.write("\t\t\t\t<select id=\"kind2\" style=\"width:90px;text-align: left;\" onchange=\"change(2)\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t<form id=\"form2\">\r\n");
      out.write("\t\t\t\t\t<div id=\"characters2\" class=\"input\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<span class=\"btn btn-info\" style=\"float:right;\" onclick=\"save(2, 'addInstrument')\" id=\"save2\"><span class=\"glyphicon glyphicon-ok\"></span>保存</span>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</section>\r\n");
      out.write("\t\t\t<section id=\"model3\">\r\n");
      out.write("\t\t\t\t<label style=\"margin-left:13px;margin-bottom:13px;\">乐器类别名：</label>\r\n");
      out.write("\t\t\t\t<select id=\"kind3\" style=\"width:90px;text-align: left;\" onchange=\"change(3)\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</select>\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<span class=\"btn btn-info\" style=\"float:right;\" onclick=\"save(3, 'search')\" id=\"save3\"><span class=\"glyphicon glyphicon-search\"></span>搜索</span>\r\n");
      out.write("\t\t\t\t</form>\t\t\t\t\r\n");
      out.write("\t\t\t</section>\r\n");
      out.write("\t   </section>\r\n");
